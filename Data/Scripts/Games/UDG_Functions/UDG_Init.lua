-- UDG_Init with copies from RTS Init 01 03 09
...
if tCurrentLevel~="Data/Levels/UDG/UDG_Instructions" then
...
UDGFUNCTIONS = {"Editor","Lights","AI","Utilities","Sounds","Fallback","Textboxes","Keyboard","Game","Music"}
	for i=1,#UDGFUNCTIONS,1 do
			tfile=gameroot.."Data/Scripts/Games/UDG_Functions/UDG_"..UDGFUNCTIONS[i]..".lua"
			dofile(tfile)
		end


	-- assign UDG entities behavior Now in its own UDG Folder
UDGENTITIES={"Teams","Emitters","Human","Zombie","Building","Gun","Car","GUI","Window","Door","Scenery","BloodPencil","MeleeWeapons","LevelExits","Furniture","Grenade","Menu"}
		for i=1,#UDGENTITIES,1 do
		local tfile = gameroot.."Data/Scripts/Games/UDG_Functions/UDG_Entities/UDG_"..UDGENTITIES[i]..".lua"
		dofile(tfile)
		end
